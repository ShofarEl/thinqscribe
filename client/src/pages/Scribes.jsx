...
const Scribes = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            ...
            >
              <h1 className="text-3xl sm:text-3xl md:text-4xl font-display text-gray-900 mb-4 leading-tight">
                Connect with Expert Academic Scribes
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <a
                  href="#scribes"
                  onClick={(e) => { e.preventDefault(); document.querySelector('#scribes')?.scrollIntoView({ behavior: 'smooth' }); }}
      ...
      {/* Scribes List */}
      <section id="scribes" className="py-16 md:py-24 bg-white">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center gap-4 md:gap-5">
                    ...
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <div className={`w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-xl ${scribe.accentColor} flex items-center justify-center p-2.5 sm:p-3 transition-transform duration-300 group-hover:scale-110`}>
                          <img
                        ...
                        <div className={`absolute -bottom-1.5 -right-1.5 ${scribe.iconColor} bg-white p-1.5 sm:p-2 rounded-lg border border-gray-100`}>
                          {scribe.icon}
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-3 md:gap-4">
                        <div className="flex-1 space-y-2.5 md:space-y-3">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {scribe.specialties.map((specialty, idx) => (
                              <span
                                key={idx}
                        ...
                        <div className="flex-shrink-0">
                          <a
                            href={`https://wa.me/${scribe.whatsapp.replace(/\s+/g, '')}?text=Hello Scribe!, I found your profile on The Scribe and would like to discuss my academic writing needs.`}
                            target="_blank"
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
                Our expert scribes are ready to assist you with personalized academic support
              </p>
            </div>
